...
std::vector<std::vector<float>> initializeMatrix(const unsigned int rows, const unsigned int cols) {
...
bool checkTranspositionCorrectness(const std::vector<std::vector<float>> &M, std::vector<std::vector<float>> &T, const unsigned int rows, const unsigned int cols) {
...
void checkCorrect(const bool sym, const std::vector<std::vector<float>> &M, std::vector<std::vector<float>> &T, const unsigned int rows, const unsigned int cols) {
    /*
